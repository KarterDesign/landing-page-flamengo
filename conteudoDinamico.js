...
const CONTEUDO_PADRAO = {
    ...
    'pacote-1-tag-1': 'TAG 01',
    'pacote-1-tag-2': 'TAG 02',
    'pacote-1-tag-3': 'TAG 03',
    'pacote-2-img': 'img/pacote oeste inferior fla+.png',
    'pacote-2-title': 'PACOTE<br>ESPAÇO FLA+',
    'pacote-2-tag-1': 'TAG 01',
    'pacote-2-tag-2': 'TAG 02',
    'pacote-2-tag-3': 'TAG 03',
    'pacote-3-img': 'img/Soccer Stadium crowd.png',
    'pacote-3-title': 'PACOTE<br>CAMAROTE',
    'pacote-3-tag-1': 'TAG 01',
    'pacote-3-tag-2': 'TAG 02',
    'pacote-3-tag-3': 'TAG 03',
